...
docDF <- function(
  ...
  dtm <- .Call(docDF_impl, as.character(target), as.character(file), as.numeric(fileN), as.integer(ft), as.integer(type), as.character(pos), as.integer(posN), as.integer(minFreq), as.integer(N), as.integer(Genkei), as.integer(nDF), as.character(opt), PACKAGE = "RMeCab")
